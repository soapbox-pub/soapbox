...
const DirectMessageUpdates = () => {
  ...
  return (
    <Stack space={3}>
      <Stack space={4} className='border-2 border-solid border-primary-800 rounded-lg p-4'>
      ...
      <Stack space={4} className='border-2 border-solid border-primary-800 rounded-lg p-4'>
        ...
        <ul className='space-y-2'>
          <li className='flex items-center space-x-2'>
            <span className='dark:text-primary-300 h-8 w-8 flex items-center justify-center text-sm font-bold rounded-full border-2 border-solid border-gray-800'>
              1
            </span>
