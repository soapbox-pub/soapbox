...
import { muteAccount } from '@/actions/accounts.ts';
import { closeModal } from '@/actions/modals.ts';
import { toggleHideNotifications, changeMuteDuration } from '@/actions/mutes.ts';
...
import DurationSelector from '@/features/compose/components/polls/duration-selector.tsx';
