  ...
  return (
    <Switch>
      ...
      */}
      ...
      <WrappedRoute path='/wallet' page={DefaultPage} component={Wallet} content={children} />
      <WrappedRoute path='/wallet-relays' page={DefaultPage} component={WalletRelays} content={children} />
      <WrappedRoute path='/wallet-mints' page={DefaultPage} component={WalletMints} content={children} />
